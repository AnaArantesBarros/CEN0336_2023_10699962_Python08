...
with open("Python_08.orf-longest.nt", "w") as seq_longest_output:
    for geneID in longest_info.keys():
        ...
        headline = f">{geneID}_{frame_longest}\n"
        codons_str = " ".join(seq_logest) + "\n"
        seq_longest_output.write(headline)
        seq_longest_output.write(codons_str)
        #print(headline,codons_str)
